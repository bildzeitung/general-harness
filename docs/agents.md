...
| **merge-agent** | Integrates completed worktree branches into the application repo's trunk branch and cleans up. Use when a coding-agent has finished a task and created a merge beads issue. |
